<template>
  <div class="p-8">
    ...
    <input
      type="text"
      class="bg-white w-full rounded border-2 border-orange-500 border-gray-200 mb-3"
    ...
    v-for="ingredient of computedIngredients" :key="ingredient.idIngredient"
      ...
      <h3 class="text-2xl font-bold mb-2 text-orange-500">{{ ingredient.idIngredient }}. {{ ingredient.strIngredient }}</h3>
